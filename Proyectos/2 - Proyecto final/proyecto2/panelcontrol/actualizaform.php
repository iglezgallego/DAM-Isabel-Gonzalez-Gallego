...
<html lang="en">
  ...
  <body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        ...
        <p style="color:#DBD5DC; padding-left:10px; font-size:20px;">Panel de control - Modificar</p>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
     ...
     <!-- Pagina principal del panel de control -->
      <div class="table-responsive">
        ...
        <form class="needs-validation" novalidate method="POST" action="actualizar.php">
          <!-- inputs -->
            ...
            <?php
                    ...
                    while ($fila = $resultado->fetch_assoc()) {
                        //si el campo es cualquiera de los siguientes, que no se muestren
                        if ($fila['Field'] == "Identificador" || $fila['Field'] == "idhijo" || $fila['Field'] == "idpadre") {
                        continue;
                        }
                        ...
                        $consulta2 = "SELECT ".$fila['Field']." AS columna FROM ".$_GET['tabla']." WHERE Identificador = ".$_GET['id'].";";

<?php
    //Pasamos el parámetro de la URL con GET. Si existe "error" y es igual a "si", saca una pestaña emergente con el mensaje
...
<html lang="es">
  <head>
    ...
    <title>YourGoals - Iniciar sesión</title>
  ...
  <body class="text-center">
    ...
    <!-- Formulario con el método "post" para el log in conectado con login.php -->

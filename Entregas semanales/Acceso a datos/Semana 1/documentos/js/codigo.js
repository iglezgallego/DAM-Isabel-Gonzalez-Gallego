        ...
        $(document).ready(function(){
                //cuando seleccione el elemento tipotexto que quiera
                ...
                $("#guardar").click(function(){
                    ...
                    $.ajax({
                        ...
                        url: "guarda.php" ,
                        //aqui especifico los datos que quiero enviar, encodeuri asegura que cualquier caracter especial de HTML se codifique de forma segura para la transmision
                        data: {datos: $("#pagina").html(), nombredocumento:$("#documentname").val()},
                        //aqui se esta haciendo una solicitud tipo POST
                        type: "POST",

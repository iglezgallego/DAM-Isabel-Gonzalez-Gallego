<?php
    ...
    //paso el parámetro user por session para que guarde en el usario correspondiente
    $midocumento = fopen("../vault/users/".$_SESSION['user']."/".$_POST['nombredocumento'].".html", "w") or die ("No se ha podido abrir el archivo");
    ...
    // Escribe el contenido de $contenido en el archivo "nombredocumento.html" en formato html

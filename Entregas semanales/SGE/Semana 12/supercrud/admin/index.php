            ...
            if(isset($_SESSION['usuario'])){
                echo '
                        ...
                        <div id="contienemenu"><ul>';
                            ...
                            while($fila = $resultado->fetch_array()){
                                ...
                                while ($fila2 = $resultado2->fetch_array()) {
                                    // Creo una variable para el comentario de la tabla
                                    $comentariotabla = json_decode($fila2["Comment"]);
                                    // Verifica si la propiedad "titulo" existe y no es nula
                                    if ($comentariotabla && isset($comentariotabla->titulo) && $comentariotabla->titulo !== null) {
                                        echo '<li><a href="?tabla='.$fila[0].'" title="'.json_decode($fila2["Comment"])->descripcion.'"><img src="../bootstrap-icons-1.11.1/'.json_decode($fila2["Comment"])->icono.'" class="icon">'.$comentariotabla->titulo.'</a></li>';
                                    } else {
                                        echo '<li><a href="?tabla='.$fila[0].'"><img src="../bootstrap-icons-1.11.1/arrow-right-circle.svg" class="icon">'.$fila[0].'</a></li>';
                                    }
                                }
                            }
                    ...
                    <section>
                        ...
                        ';
                            //Si existe informe, llamo a la funcion informe con los valores de la tabla e informe
